...
class NeuMF(GeneralModel):
    ...
    def fix_embedding_layer(self):
        self.mf_u_embeddings.weight.requires_grad = False
        self.mf_i_embeddings.weight.requires_grad = False
        self.mlp_u_embeddings.weight.requires_grad = False
        self.mlp_i_embeddings.weight.requires_grad = False
